...
router.post('/get-specific-products-by-slugs',controller.getSpecificProductsBySlug)
// Modify
...
router.post('/update-bulk-product-field', controller.bulkProductFieldUpdate);
